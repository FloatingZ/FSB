...
public class Taint {
    ...
    public boolean collectionIsVaild;
    public boolean isMap;
    public boolean isList;
    public Map<String, State> innerMap;
    public List<State> innerList;
    ...
    public Taint(State state) {
        ...
        this.fields = new HashMap<String, State>();
        this.state = state;
    ...
    public Taint(Taint taint) {
        ...
        this.isMap = taint.isMap;
        this.isList = taint.isList;
        this.collectionIsVaild = taint.collectionIsVaild;
        this.innerMap = (taint.innerMap!=null)?new HashMap<String,State>(taint.innerMap):null;
    ...
    public void setCollection(Taint t){
        this.isMap = t.isMap;
        this.isList = t.isList;
        if(t.innerList != null && t.innerList.size()>0)
            this.innerList = new ArrayList<State>(t.innerList);
        if(t.innerMap != null&& t.innerMap.size()>0)
            this.innerMap = new HashMap<String,State>(t.innerMap);
        this.collectionIsVaild = t.collectionIsVaild;
    }

    public void initList(){
        this.isList = true;
        if(innerList == null)
            innerList = new ArrayList<State>();
    }

    public void initMap(){
        this.isMap = true;
        if (innerMap == null)
            innerMap = new HashMap<String,State>();
    }
...
//        }
    ...
    public boolean equalignorestate(Object obj){
        if (this == obj) {
            return true;
        }
        if (obj == null) {
